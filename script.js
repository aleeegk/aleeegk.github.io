...
const EVENTS_EN = [
  ...
  { year: 2012, evento: 'Discovery of the Higgs boson', datoCurioso: 'Peter Higgs predicted its existence in 1964, almost 50 years before it was confirmed.', cat: 'historia', contexto: 'It is a subatomic particle that explains why other particles have mass; without it, matter as we know it would not exist.' },
  ...
  { year: 1953, evento: 'Structure of DNA', datoCurioso: 'The key photograph (Photo 51) was taken by Rosalind Franklin.', cat: 'biologia', contexto: 'It is the molecule that contains the genetic instructions needed for the development and functioning of all living beings.' },
  ...
  { year: 1928, evento: 'Discovery of penicillin', datoCurioso: 'Alexander Fleming found it by accident in a forgotten petri dish.', cat: 'biologia', contexto: 'It was the first effective antibiotic in history, able to cure bacterial infections that were previously fatal.' },
  ...
  { year: 1869, evento: 'Mendeleev\'s periodic table', datoCurioso: 'He predicted the existence of undiscovered elements and was right.', cat: 'historia', contexto: 'It is a system for classifying and organising all chemical elements according to their properties and atomic mass.' },
  { year: 1859, evento: 'Publication of "On the Origin of Species"', datoCurioso: 'It sold out on the first day of publication.', cat: 'biologia', contexto: 'The work in which Darwin laid out the theory of evolution by natural selection of species.' },
  ...
  { year: 1687, evento: 'Newton\'s Laws', datoCurioso: 'In "Principia" he formulates the law of universal gravitation.', cat: 'geologia', contexto: 'Physical principles that describe the motion of objects and the force of gravity that governs the universe.' },
  { year: 1608, evento: 'Telescope', datoCurioso: 'Galileo improved it a year later and pointed it at the sky.', cat: 'historia' },
  { year: 1543, evento: 'Copernican Revolution', datoCurioso: 'The book claiming the Earth revolves around the Sun was published the year he died.', cat: 'geologia', contexto: 'It showed that the Earth and the other planets revolve around the Sun, and not the other way around.' },
...
const EVENTS_FR = [
  ...
  { year: 2012, evento: 'Découverte du boson de Higgs', datoCurioso: 'Peter Higgs avait prédit son existence en 1964, près de 50 ans avant sa confirmation.', cat: 'historia', contexto: 'C\'est une particule subatomique qui explique pourquoi les autres particules ont une masse ; sans elle, la matière telle que nous la connaissons n\'existerait pas.' },
  ...
  { year: 1953, evento: 'Structure de l\'ADN', datoCurioso: 'La photo clé (Photo 51) a été prise par Rosalind Franklin.', cat: 'biologia', contexto: 'C\'est la molécule qui contient les instructions génétiques nécessaires au développement et au fonctionnement de tous les êtres vivants.' },
  ...
  { year: 1928, evento: 'Découverte de la pénicilline', datoCurioso: 'Alexander Fleming l\'a trouvée par accident dans une culture oubliée.', cat: 'biologia', contexto: 'Ce fut le premier antibiotique efficace de l\'histoire, capable de guérir des infections bactériennes autrefois mortelles.' },
  ...
  { year: 1869, evento: 'Tableau périodique de Mendeleïev', datoCurioso: 'Il a prédit l\'existence d\'éléments non encore découverts et avait raison.', cat: 'historia', contexto: 'C\'est un système permettant de classer et d\'organiser tous les éléments chimiques selon leurs propriétés et leur masse atomique.' },
  { year: 1859, evento: 'Publication de « L\'Origine des espèces »', datoCurioso: 'Épuisé dès le premier jour de vente.', cat: 'biologia', contexto: 'Ouvrage dans lequel Darwin a exposé la théorie de l\'évolution par sélection naturelle des espèces.' },
  ...
  { year: 1687, evento: 'Lois de Newton', datoCurioso: 'Dans les « Principia », il formule la loi de la gravitation universelle.', cat: 'geologia', contexto: 'Principes physiques qui décrivent le mouvement des objets et la force de gravité qui régit l\'univers.' },
  { year: 1608, evento: 'Télescope', datoCurioso: 'Galilée l\'a amélioré un an plus tard et l\'a pointé vers le ciel.', cat: 'historia' },
  { year: 1543, evento: 'Révolution copernicienne', datoCurioso: 'Le livre affirmant que la Terre tourne autour du Soleil a été publié l\'année de sa mort.', cat: 'geologia', contexto: 'Il a démontré que la Terre et les autres planètes tournent autour du Soleil, et non l\'inverse.' },
...
const EVENTS_IT = [
  ...
  { year: 2012, evento: 'Scoperta del bosone di Higgs', datoCurioso: 'Peter Higgs ne aveva predetto l\'esistenza nel 1964, quasi 50 anni prima della conferma.', cat: 'historia', contexto: 'È una particella subatomica che spiega perché le altre particelle hanno massa; senza di essa, la materia come la conosciamo non esisterebbe.' },
  ...
  { year: 1953, evento: 'Struttura del DNA', datoCurioso: 'La foto chiave (Foto 51) fu scattata da Rosalind Franklin.', cat: 'biologia', contexto: 'È la molecola che contiene le istruzioni genetiche necessarie per lo sviluppo e il funzionamento di tutti gli esseri viventi.' },
  ...
  { year: 1928, evento: 'Scoperta della penicillina', datoCurioso: 'Alexander Fleming la trovò per caso in una coltura dimenticata.', cat: 'biologia', contexto: 'Fu il primo antibiotico efficace della storia, capace di curare infezioni batteriche prima mortali.' },
  ...
  { year: 1869, evento: 'Tavola periodica di Mendeleev', datoCurioso: 'Predisse l\'esistenza di elementi non ancora scoperti e ci azzeccò.', cat: 'historia', contexto: 'È un sistema per classificare e organizzare tutti gli elementi chimici in base alle loro proprietà e alla massa atomica.' },
  { year: 1859, evento: 'Pubblicazione de «L\'origine delle specie»', datoCurioso: 'Esaurito il primo giorno di vendita.', cat: 'biologia', contexto: 'Opera in cui Darwin espose la teoria dell\'evoluzione per selezione naturale delle specie.' },
  ...
  { year: 1687, evento: 'Leggi di Newton', datoCurioso: 'Nei «Principia» formula la legge della gravitazione universale.', cat: 'geologia', contexto: 'Principi fisici che descrivono il moto degli oggetti e la forza di gravità che governa l\'universo.' },
  { year: 1608, evento: 'Telescopio', datoCurioso: 'Galileo lo migliorò un anno dopo e lo puntò verso il cielo.', cat: 'historia' },
  { year: 1543, evento: 'Rivoluzione copernicana', datoCurioso: 'Il libro che affermava che la Terra ruota intorno al Sole fu pubblicato l\'anno della sua morte.', cat: 'geologia', contexto: 'Dimostrò che la Terra e gli altri pianeti ruotano intorno al Sole, e non viceversa.' },
...
const EVENTS_CA = [
  ...
  { year: 2012, evento: 'Descobriment del bosó de Higgs', datoCurioso: 'Peter Higgs en va predir l\'existència el 1964, gairebé 50 anys abans de confirmar-se.', cat: 'historia', contexto: 'És una partícula subatòmica que explica per què la resta de partícules tenen massa; sense ella, la matèria tal com la coneixem no existiria.' },
  ...
  { year: 1953, evento: 'Estructura de l\'ADN', datoCurioso: 'La foto clau (Foto 51) va ser feta per Rosalind Franklin.', cat: 'biologia', contexto: 'És la molècula que conté les instruccions genètiques necessàries per al desenvolupament i funcionament de tots els éssers vius.' },
  ...
  { year: 1928, evento: 'Descobriment de la penicil·lina', datoCurioso: 'Alexander Fleming la va trobar per accident en un cultiu oblidat.', cat: 'biologia', contexto: 'Va ser el primer antibiòtic eficaç de la història, capaç de curar infeccions bacterianes abans mortals.' },
  ...
  { year: 1869, evento: 'Taula periòdica de Mendeléiev', datoCurioso: 'Va predir l\'existència d\'elements encara no descoberts i va encertar.', cat: 'historia', contexto: 'És un sistema per classificar i organitzar tots els elements químics segons les seves propietats i massa atòmica.' },
  { year: 1859, evento: 'Publicació de «L\'origen de les espècies»', datoCurioso: 'Es va esgotar el primer dia de venda.', cat: 'biologia', contexto: 'Obra on Darwin va exposar la teoria de l\'evolució per selecció natural de les espècies.' },
  ...
  { year: 1687, evento: 'Lleis de Newton', datoCurioso: 'Als «Principia» formula la llei de la gravitació universal.', cat: 'geologia', contexto: 'Principis físics que descriuen el moviment dels objectes i la força de gravetat que governa l\'univers.' },
  { year: 1608, evento: 'Telescopi', datoCurioso: 'Galileu el va millorar un any després i el va apuntar al cel.', cat: 'historia' },
  { year: 1543, evento: 'Revolució Copernicana', datoCurioso: 'El llibre que afirmava que la Terra gira al voltant del Sol es va publicar l\'any de la seva mort.', cat: 'geologia', contexto: 'Va demostrar que la Terra i la resta de planetes giren al voltant del Sol, i no a l\'inrevés.' },
